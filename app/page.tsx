...
// Deploy marker: 2026-04-29 11:29 UTC
    ...
    <div className="font-sans min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-24 bg-white flex-1">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mb-10">
          Tendly uses AI to match your business profile to active SAM.gov
          solicitations — so you spend less time searching and more time
          winning.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                AI matches your NAICS codes to active solicitations so you only
                see contracts relevant to your business.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3
              ...
              <p className="text-gray-600 text-sm">
                Filter by 8(a), SDVOSB, HUBZone, WOSB certifications to find
                contracts you are eligible to win.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3
              ...
              <p className="text-gray-600 text-sm">
                Real-time alerts for contracts matching your profile so you
